...
def load_data_rating(path="../data/ml100k/movielens_100k.dat", header=['user_id', 'item_id', 'rating', 'category'],
    ...
    train_data, test_data = train_test_split(df, test_size=test_size,random_state=2010)
    # train_data, test_data = train_test_split(df, test_size=test_size,random_state=4)

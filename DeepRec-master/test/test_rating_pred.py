...
def parse_args():
    ...
    parser.add_argument('--model', choices=['MF'], default='MF')
    # , 'NNMF', 'NRR', 'I-AutoRec', 'U-AutoRec', 'FM', 'NFM', 'AFM'
...
if __name__ == '__main__':
    ...
    train_data, test_data, n_user, n_item = load_data_rating(path="../Data/ml100k/ratings.dat",
                                                             header=['user_id', 'item_id', 'rating', 't'],
                                                             test_size=0.1, sep="\t")
    print('num_user,num_item',n_user,n_item)
